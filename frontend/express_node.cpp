...
bool ExpressNode::isUnaryOperation() {
  return _operation == OperationType::UN_PLUS ||
         _operation == OperationType::UN_MINU ||
         _operation == OperationType::UN_NOT;
}

void ExpressNode::addChild(SharedExNdPtr child) { _children.push_back(child); }
