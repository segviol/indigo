...
const string Token_strs[] = {
    "IDENFR",  "INTCON", "STRCON",  "CONSTTK", "INTTK",      "VOIDTK",
    "IFTK",    "ELSETK", "WHILETK", "BREAK",   "CONTINUETK", "RETURNTK",
    "PLUS",    "MINU",   "MULT",    "DIV",     "MOD",        "LSS",
    "LEQ",     "GRE",    "GEQ",     "EQL",     "NEQ",        "AND",
    "OR",      "NOT",    "ASSIGN",  "SEMICN",  "COMMA",      "LPARENT",
