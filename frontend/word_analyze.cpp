...
inline bool front::word::hex_digit(char ch) {
  ...
  return isdigit(ch) || l_ch == 'a' || l_ch == 'b' || l_ch == 'c' ||
         l_ch == 'd' || l_ch == 'e' || l_ch == 'f';
}
...
inline bool front::word::is_nodigit(char c) { return isalpha(c) || (c == '_'); }
...
Token Word::get_token_value() { return token_value; }

string Word::get_token_string() { return Token_strs[(int)token_value]; }

string Word::get_self() const { return self; }

bool Word::match_token(Token tk) const { return token_value == tk; }

unsigned int Word::get_line_num() const { return line_num; }
